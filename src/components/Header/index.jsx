...
function Header(props) {
  return (
    <header className='container p-3 py-5 border-b-4 shadow-md'>
      <nav className='flex justify-between'>
        <h1 className='font-bold'>Micko - React Wiki Search Engine</h1>
        <button onClick={props.toggleDarkMode} type="button" class="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5">
          {
            props.darkMode ? 
